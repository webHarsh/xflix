...
const apis = {
    ...
    uploadNewVideo(videoLink, title, genre, contentRating, releaseDate, previewImage) {
        let data = {
            "videoLink": videoLink,
            "title": title,
            "genre": genre,
    ...
    getVideoByGenre(genre) {
        cy.log(this.baseUrl + '/videos?genres=' + genre);
        return cy.request('GET', this.baseUrl + '/videos?genres=' + genre);
    },
